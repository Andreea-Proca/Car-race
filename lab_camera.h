    ...
    class Cam
    {
     public:
        Cam()
        {
            ...
            forward     = glm::vec3(0, 0, -1);  // pe OZ
            up          = glm::vec3(0, 1, 0);   // pe OY
            right       = glm::vec3(1, 0, 0);   // pe Ox
            distanceToTarget = sqrt(0.9);
        }
        ...
        void MoveForward(float distance)
        {
            ...
            // forward.y = 0 -> proiectam vectorul de directie pe axa XOZ si nu se mai misca in sus, merge doar inainte pe OX
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::normalize(
                glm::vec3(
                    glm::rotate(glm::mat4(1), angle, right) 
                    * glm::vec4(forward, 1)));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // ** forward si right se calc in fct de axa OY(nu de up) pt ca se modifica si up **
            forward = glm::normalize(
                glm::vec3(
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::normalize(
                glm::vec3(
                    glm::rotate(glm::mat4(1), angle, forward)
                    * glm::vec4(right, 1)));
            up = glm::normalize(glm::cross(right, forward));
        }
